<template>
  <v-app>
    ...
    <v-app-bar app flat elevation="8" absolute color="transparent">
    ...
    <v-main>
      <div class="app-content-container boxed-container pa-5">
        <slot></slot>
      </div>
    </v-main>
    ...
    <v-footer app inset color="transparent" absolute height="56" class="px-0">
      <div class="boxed-container w-full">
        <div class="mx-6 d-flex justify-space-between">
          <span>
            &copy; 2022
            <a href="https://themeselection.com" class="text-decoration-none" target="_blank">AKTIVOS</a>
          </span>
          <!--
