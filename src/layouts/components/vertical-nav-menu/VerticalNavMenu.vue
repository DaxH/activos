  ...
  >
    ...
    <div class="vertical-nav-header d-flex items-center ps-6 pe-5 pt-5 pb-2">
      <router-link to="/" class="d-flex align-center text-decoration-none">
        <v-img
          :src="require('@/assets/images/logos/logos.png')"
          max-height="500px"
          max-width="150px"
          alt="logo"
          contain
        ...
        <!-- <v-slide-x-transition>
          <h2 class="app-title text--primary">Activos</h2>
        </v-slide-x-transition>
    ...
    <v-list expand shaped class="vertical-nav-menu-items pr-5">
      ...
      <nav-menu-link title="Localidad" :to="{ name: 'location' }" :icon="icons.mdiGoogleMaps" />
      <nav-menu-link title="Activos" :to="{ name: 'listActivos' }" :icon="icons.mdiTable"></nav-menu-link>
      <nav-menu-link title="Transferencia" :to="{ name: 'transfer' }" :icon="icons.mdiSwapHorizontal"></nav-menu-link>
      <nav-menu-link title="Alertas" :to="{ name: 'alerts' }" :icon="icons.mdiAlarmLight"></nav-menu-link>
      <!--
  <nav-menu-link
...
export default {
  ...
  beforeMount() {
    console.log('Componente de Nav Bar ', this.holi)
  },
}
</script>
